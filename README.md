...
| metric | definition |
| --- | --- |
| neural network | <img src="https://latex.codecogs.com/png.latex?\dpi{150}&space;f:\mathbb{R}^{M_{in}}\to\mathbb{R}^{C}"/> |
| parameters | <img src="https://latex.codecogs.com/png.latex?\dpi{150}&space;\theta\in\mathbb{R}^{P}"/> |
